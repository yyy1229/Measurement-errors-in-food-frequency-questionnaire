...
```{r , fig.cap = "Scoring methods for plant-based diet indices", fig.fullwidth=TRUE}
...
```{r , fig.cap = "Illustration of simulated main and validation study"}
...
**Figure 6**.RMSE in beta estimates before and after correcting for
measurement error
...
tab1 %>% 
  knitr::kable(
    caption = " Table1. Summary statistics of the dietary exposures derived from FFQs and dietary records ",
    align = "l",
    digits = 2,
    booktabs = TRUE,
    longtable = TRUE,
...
tab2 %>% 
  knitr::kable(
    caption = " Table2. Reproducibility and validity results  ",
    align = "l",
    digits = 2,
    longtable = TRUE,
    linesep = "",
